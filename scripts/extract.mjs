  ...
  return players.map((p) => {
    ...
    return {
      ...
      stats: {
        ...
        // Uses, not purchases. The emblem pays for a smoke that was popped,
        // and a support who buys one for a team-mate never pops it - across
        // TI 2026's supports the two differ by a factor between 0.67 and 1.03
        // per player, so it reorders the ranking rather than just scaling it.
        ...
        // the contested subset, not the total.
