...
39 checks across five Internationals, plus a cross-check against an independent
community table (currently **33 of 38** values within 45%). It exits non-zero on
